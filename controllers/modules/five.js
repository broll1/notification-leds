...
var colorMap = require('../../config/led-colors.js');
var hardwareSupport = require('../../config/hardwareConfig');
...
exports.initBoard = function(callback){
    ...
    board.on("ready", function() {
        ...
        pins: {
            red : hardwareSupport.redpin,
            green: hardwareSupport.greenpin,
            blue: hardwareSupport.bluepin,
        }
    });
    console.log(leds);
    this.repl.inject({
